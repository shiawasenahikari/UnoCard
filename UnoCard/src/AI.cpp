    ...
    if (nextSize == 1) {
        ...
        if (lastColor == nextStrongColor) {
            ...
            if (hasNumIn[safeColor]) {
                ...
                prevSize >= 4 &&
                hand.at(idxRev)->color != nextStrongColor) {
                idxBest = idxRev;
            } // else if (hasRev && ...)
            else if (hasSkip &&
                hand.at(idxSkip)->color != nextStrongColor) {
                idxBest = idxSkip;
            } // else if (hasSkip && ...)
        } // else if (nextStrongColor != NONE)
        else {
        ...
        if (lastColor == prevStrongColor) {
            ...
            if (hasSkip &&
                hand.at(idxSkip)->color != prevStrongColor) {
        ...
        if (lastColor == oppoStrongColor) {
            ...
            if (hasNumIn[safeColor]) {
                ...
                hand.at(idxRev)->color != oppoStrongColor) {
                idxBest = idxRev;
            } // else if (hasRev && ...)
            else if (hasSkip &&
                hand.at(idxSkip)->color != oppoStrongColor) {
                idxBest = idxSkip;
            } // else if (hasSkip && ...)
            else if (hasDraw2 &&
                hand.at(idxDraw2)->color != oppoStrongColor) {
                idxBest = idxDraw2;
            } // else if (hasDraw2 && ...)
            else if (hasWild) {
...
int AI::sevenZeroAI_bestCardIndex4NowPlayer(Card* drawnCard, Color outColor[]) {
    ...
    if (nextSize == 1) {
        ...
        if (has7 && (yourSize > 2
            ...
            hand.at(idxNum)->color != nextStrongColor) {
            idxBest = idxNum;
        } // else if (hasNum && ...)
        ...
        if (has0) {
            ...
            hand.at(idxDraw2)->color != prevStrongColor) {
            idxBest = idxDraw2;
        } // else if (hasDraw2 && ...)
        ...
        // Normal strategies
        if (has0 && hand.at(idx0)->color == prevStrongColor) {
            idxBest = idx0;
        } // if (has0 && hand.at(idx0)->color == nextStrongColor)
        else if (has7 && (hand.at(idx7)->color == prevStrongColor
            || hand.at(idx7)->color == oppoStrongColor
            || hand.at(idx7)->color == nextStrongColor)) {
            idxBest = idx7;
        } // else if (has7 && ...)
        else if (hasRev && prevSize > nextSize) {
            idxBest = idxRev;
